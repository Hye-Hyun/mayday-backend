...
public class IncomeService {
    ...
    public IncomeProgressResponse getProgress(Long userId) {
        ...
        IndustryCategory industryCategory = user.getIndustryCategory();
        ...
        long standardAmount = industryCategory.getStandardAmount();
    ...
    public IncomeCreateResponse create(Long userId, IncomeCreateRequest request) {
        Income income = Income.create(userId, request.getAmount(), request.getDate());
    ...
    public IncomeUpdateResponse update(Long userId, String incomeId, IncomeUpdateRequest request) {
        ...
        income.update(request.getAmount(), request.getDate());
