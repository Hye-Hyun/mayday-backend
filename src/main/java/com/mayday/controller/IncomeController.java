...
public class IncomeController {
    ...
    public ResponseEntity<ApiResponse<IncomeCreateResponse>> createIncome(
        ...
        return ResponseEntity
                ...
                .body(ApiResponse.created("수입 기록 저장 성공", incomeService.create(userId, request)));
    }
    ...
    @GetMapping("/{incomeId}")
    public ResponseEntity<ApiResponse<IncomeDetailResponse>> getIncome(
            @AuthenticationPrincipal Long userId,
            @PathVariable String incomeId
    ) {
        return ResponseEntity.ok(
                ApiResponse.ok("수입 상세 조회 성공", incomeService.getDetail(userId, incomeId))
        );
    }
    ...
    public ResponseEntity<ApiResponse<IncomeUpdateResponse>> updateIncome(
        ...
        return ResponseEntity.ok(
                ApiResponse.ok("수입 기록 수정 성공", incomeService.update(userId, incomeId, request))
        );
    }
    ...
    public ResponseEntity<ApiResponse<Void>> deleteIncome(
        ...
        return ResponseEntity.ok(ApiResponse.ok("수입 기록 삭제 성공", null));
    }
}
